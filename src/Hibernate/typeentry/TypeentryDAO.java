...
/**
 	* A data access object (DAO) providing persistence and search support for Typeentry entities.
...
public class TypeentryDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TypeentryDAO.class);
		//property constants
    ...
    public Typeentry findById( java.lang.Integer id) {
        ...
        try {
            Typeentry instance = (Typeentry) getSession()
                    .get("hibernate.typeentry.Typeentry", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Typeentry merge(Typeentry detachedInstance) {
        ...
        try {
            Typeentry result = (Typeentry) getSession()
